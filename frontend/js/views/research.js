...
const CATEGORY_ORDER = [
    "All",
    "Quantum and Transdimensional",
    "Etheric and Cosmic",
    "Biological and Xenogenetic",
    "Existential and Metaconscious",
    "Engineering and Applied Etheric",
    "Computational and Predictive",
    "Planetary, Stellar, and Environmental",
    "Ethics, Philosophy, and Intercultural",
    "Health, Medicine, and Post-Mortality",
    "Theoretical and Foundational",
    "Ship Technology Sciences",
];

/** Short display labels for each category (keeps filter tabs compact) */
const CATEGORY_SHORT = {
    "All":                                  "All",
    "Quantum and Transdimensional":         "Quantum",
    "Etheric and Cosmic":                   "Etheric",
    "Biological and Xenogenetic":           "Biology",
    "Existential and Metaconscious":        "Consciousness",
    "Engineering and Applied Etheric":      "Engineering",
    "Computational and Predictive":         "Computing",
    "Planetary, Stellar, and Environmental":"Planetary",
    "Ethics, Philosophy, and Intercultural":"Philosophy",
    "Health, Medicine, and Post-Mortality": "Medicine",
    "Theoretical and Foundational":         "Theory",
    "Ship Technology Sciences":             "Ships",
};

/** Category accent colours for card left-border */
const CATEGORY_COLORS = {
    "Quantum and Transdimensional":         "var(--accent-cyan)",
    "Etheric and Cosmic":                   "var(--accent-purple)",
    "Biological and Xenogenetic":           "var(--accent-green)",
    "Existential and Metaconscious":        "var(--accent-gold)",
    "Engineering and Applied Etheric":      "var(--accent-teal)",
    "Computational and Predictive":         "var(--accent-cyan)",
    "Planetary, Stellar, and Environmental":"var(--accent-green)",
    "Ethics, Philosophy, and Intercultural":"var(--accent-orange)",
    "Health, Medicine, and Post-Mortality": "var(--accent-green)",
    "Theoretical and Foundational":         "var(--accent-purple)",
    "Ship Technology Sciences":             "var(--accent-teal)",
};
